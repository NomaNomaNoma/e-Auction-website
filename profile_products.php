...
<div class="agile_inner_breadcrumb" id="youracct">
	...
	<div class="ads-grid">
		<div class="container">
			<!-- tittle heading -->
		  <h3 class="tittle-w3l"> My Products
	...
	<footer>
	  <div class="container">
	    ...
	    <div class="footer-info w3-agileits-info">
	      ...
	      <!-- //footer categories -->
	      <!-- quick links -->
	      <div class="col-sm-5 address-right" align="center">
	      ...
	      <!-- //quick links -->
	      <!-- social icons -->
	      <div class="col-sm-2 footer-grids  w3l-socialmk" align="center">
	        <h3>Follow Us on</h3>
	        <div class="social">
	          <ul>

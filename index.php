		...
		<div class="container">
			...
			<div class="side-bar col-md-3">
				<div class="search-hotel">
					...
					<li> <a href="#" data-toggle="modal" data-target="#myModal1">What is "Database Daredevils"  </a> </li>
					<br>
					<li> <a href="#" data-toggle="modal" data-target="#myModal2">How to use "e-Auction"  </a> </li>
					<br>
					<li> <a href="#" data-toggle="modal" data-target="#myModal3">Can I sell products  </a> </li>
					<br>
					<li> <a href="#" data-toggle="modal" data-target="#myModal4">What are coupons  </a> </li>
					<br>
					<li><a href="contact.php">More questions? Let us know!</a></li>
				</div>
			...
			<div class="modal-content">
				<div class="modal-body modal-body-sub_agile">
					...
					<div class="modal_body_left modal_body_left1">
						<h3 class="agileinfo_sign">Database Daredevils</h3>
						<p>
							"Database Daredevils" is an e-Auction commerce company which aims to provide customers with the unmatched opportunities of online auction along with the regular trade opportunities.
						</p>
					</div>
				</div>
			</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body modal-body-sub_agile">
					...
					<div class="modal_body_left modal_body_left1">
						<h3 class="agileinfo_sign">e-Auction</h3>
						<p>
							"e-Auction" is very easy to use. You can search and browse products as you wish. Each product contains "Buy it now" price, which means you can get this product without bidding. Or you can bid with other users by using "I want it". If you win the acution, you can easily add it to your shopping cart.
						</p>
					</div>
				</div>
			</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body modal-body-sub_agile">
					...
					<div class="modal_body_left modal_body_left1">
						<h3 class="agileinfo_sign">Sell Products</h3>
						<p>
							Yes you can! All users including individual users and company users are encouraged to sell products. The newest three products in particular categories will be shown on homepage. However, company users are NOT allowed to buy products.
						</p>
					</div>
				</div>
			</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body modal-body-sub_agile">
					...
					<div class="modal_body_left modal_body_left1">
						<h3 class="agileinfo_sign">Coupons</h3>
						<p>
							Coupons are discounts to help you save money. For now all users can get 10% off when checking out. In the future, we'll update coupon system to give you more discounts.
						</p>
					</div>
				</div>
			</div>
			...
			<div class="agileinfo-ads-display col-md-9">
				<div class="wrapper">
					...
					<div class="product-sec1">
					  <h3 class="heading-tittle" data_temp_dwid="1">Electronics</h3>	
						<?php
						include_once("db.php");
								$sql="SELECT * FROM products where Categories='Electronics' order by ID DESC LIMIT 3";

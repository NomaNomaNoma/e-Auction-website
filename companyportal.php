...
<div class="welcome">
		<div class="container">
			<!-- tittle heading -->
			<h3 class="tittle-w3l"><?php echo $_SESSION['username']?>
			...
			<div class="w3l-welcome-info">
				<div class="col-sm-6 col-xs-6 welcome-grids">
					<div class="welcome-img">
						<img src="images/sellproducts.png" class="img-responsive zoom-img" alt="">
						<div class="middle">
						<div class="text"><a href="additem.php">
								Sell Products</a></div>
				...
				<div class="col-sm-6 col-xs-6 welcome-grids">
					<div class="welcome-img">
						<img src="images/editproducts.png" class="img-responsive zoom-img" alt="">
						<div class="middle">
						<div class="text"><a href="profile_products.php">
								Edit Products</a></div>
